...
"""
Helper functions used to compute 3D geometric transformations.
"""
...
def to_transformation_matrix(translation, orientation_matrix=np.zeros((3, 3))):
    ...
    :param np.array translation: The translation of your frame presented as a 3D
        vector.
    :param np.array orientation_matrix: Optional : The orientation of your
        frame, presented as a 3x3 matrix.
    """
    matrix = np.eye(4)
...
def cartesian_to_homogeneous(cartesian_matrix, matrix_type="numpy"):
    ...
    # Add a column filled with 0 and finishing with 1 to the cartesian matrix to
    # transform it into an homogeneous one.
