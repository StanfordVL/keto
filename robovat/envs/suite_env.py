...
def load(env_name,
    ...
    Args:
        ...
        spec_dtype_map: A dict that maps gym specs to tf dtypes to use as the
            ...
            returns desired mapping and call it in your Gin config file, for
            example: `suite_gym.load.spec_dtype_map = @get_custom_mapping()`.
    Returns:
...
def wrap_env(gym_env,
    ...
    Args:
        ...
        spec_dtype_map: A dict that maps gym specs to tf dtypes to use as the
            ...
            returns desired mapping and call it in your Gin config file, for
            example: `suite_gym.load.spec_dtype_map = @get_custom_mapping()`.
        auto_reset: If True (default), reset the environment automatically after
