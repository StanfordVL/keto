...
from robovat.envs.reward_fns.combine_reward import CombineReward
...
class CombinePointCloudEnv(arm_env.CombineArmEnv):
    """Top-down 4-DoF combine environment."""
    ...
    def __init__(self,
        ...
        super(CombinePointCloudEnv, self).__init__(
    ...
    def reset_scene(self):
        ...
        """
        super(CombinePointCloudEnv, self).reset_scene()
    ...
    def reset_robot(self):
        ...
        """
        super(CombinePointCloudEnv, self).reset_robot()
        ...
        if self.simulator:
            if phase == 'prestart':
                if self.simulator.check_contact(self.robot.arm, self.ceil):
                    logger.debug('The gripper contacts the ceil')
                    return True
            if phase == 'start':
