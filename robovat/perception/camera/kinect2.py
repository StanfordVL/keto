...
This is modified from Berkeley AutoLab perception.
"""
...
# TODO(kuanfang): Add camera intrinsics properties back after removing the
# AutoLab dependencies in CameraIntrinsics.
...
class Kinect2(Camera):
    ...
    def __init__(self,
        ...
        Args:
            ...
            registration_mode: The mode for registering a color image to the IR
                camera frame of reference. Either Kinect2RegistrationMode.NONE
                or Kinect2RegistrationMode.COLOR_TO_DEPT.
            ...
            skip_registration: If True, the registration step is skipped.
