...
class Grasp4DofPointCloudProblem(problem.Problem):
    """DexNet Problem."""
    ...
    def __init__(self,
                 ...
                 num_points=1024):
        """Initialize."""
        super(Grasp4DofPointCloudProblem, self).__init__(
    ...
    def convert_trajectory(self, trajectory):
        ...
        point_cloud = trajectory.observation['point_cloud']
        grasps = trajectory.action
        feed_dict = {
            self.point_cloud_ph: point_cloud,
