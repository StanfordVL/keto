...
from robovat.math import mesh_utils
from robovat.utils.logging import logger


# TODO(kuanfang): Temporally remove the V-HACD parameters chosen by virajmehta
# for simplicity, will add them back if we find the results are not as good.
VHACD_COMMAND = (
        './bin/vhacd'
        ' --input {input_path:s}'
...
def _count_output_groups(wrl_path):
...
def process_object(input_path, output_dir, rgba, scale=1.0,
                   mass=0.1, density=None):
